...
Jph_GaAs_1 = q * np.trapezoid(results_per_layer_front[:, 3] * spectr_flux, wavelengths) / 10  # mA/cm2
Jph_GaAs_2 = q * np.trapezoid(results_per_layer_front[:, 7] * spectr_flux, wavelengths) / 10  # mA/cm2
