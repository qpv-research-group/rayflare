...
triangle_surf_smooth = regular_pyramids(elevation_angle=55, upright=True, size=1,
...
for j1, nh in enumerate(noise_heights):
    ...
    triangle_surf = rough_pyramids(elevation_angle=55, upright=True, size=1,
                                     noise_fraction=nh,
    ...
    rtstr_coh = rt_structure(textures=[triangle_surf, triangle_surf_smooth, triangle_surf_back],
