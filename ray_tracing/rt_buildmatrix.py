...
def RT(group, incidence, transmission, options):
    ...
    if not options['parallel']:
        ...
        bin_in = phi_in.groupby('theta_bin').apply(overall_bin_xarray,
        ...
        bin_out = phi_out.groupby('theta_bin').apply(overall_bin_xarray,
                                           args=(phi_intv, angle_vector[:, 0])).data
...
def overall_bin_xarray(x, phi_intv, angle_vector_0):
