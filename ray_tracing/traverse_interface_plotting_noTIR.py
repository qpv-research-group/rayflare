...
def single_ray(x, y, theta, phi, surfaces, materials, n_depths, I_thresh, ax):
    ...
    while not stop:
        ...
        res, theta, r_a, d, ray_path = single_interface_check(r_a, d, materials['nk'][mat_index],
                                     materials['nk'][mat_index+1], surf, surf.Lx, surf.Ly, direction, surf.zcov, ax, ray_path)
...
def single_interface_check(r_a, d, n0, n1, tri, Lx, Ly, side, z_cov, ax, ray_path):
