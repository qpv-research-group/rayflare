...
options =  {'wavelengths': wavelengths, 'I_thresh': 1e-4, 'theta': 0, 'phi': 0,
            'nx': 2, 'ny': 2, 'max_passes': 50, 'parallel': False, 'n_jobs': -1, 'n_rays': 1000,
...
allArrays, absArrays, prof_data = RT(group, incidence, transmission, 'GaAsGaAsstack_prof', 2, options, 'front', [0,1])
print('Time taken = ', time() - start, ' s')

#allArrays, absArrays = RT(group, transmission, incidence, 'GaAsGaAsstack_prof', 2, options, 'rear')
#print('Time taken = ', time() - start, ' s')
#
